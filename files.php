    ...
    <main class="bg-[url(../src/img/emfrentepraia.jpg)] min-h-screen min-w-screen">
        <div class="backdrop-blur-xs backdrop-grayscale-50 min-h-screen min-w-screen bg-none flex justify-center items-center flex-col">
            <div class="flex w-full">
                ...
                <div class="m-10 h-fit bg-slate-700 flex-col rounded-2xl flex w-1/2 justify-around p-10 font-semibold text-2xl text-amber-100 drop-shadow-[15px_15px_7px_rgba(0,0,30,.7)]">
            ...
            <div class="flex w-full">
                <div class="m-10 bg-slate-700 flex-col rounded-2xl flex w-1/2 justify-around p-10 font-semibold text-2xl text-amber-100 drop-shadow-[15px_15px_7px_rgba(0,0,30,.7)]">
                    <h1 class="text-center text-3xl font-bold mb-6 text-amber-600">Todos os Comentários:</h1>
                    ...
                    <form action="./src/uploads/tocomment.php" method="post">
                        <button type="submit" name="aprovar" value="<?= $depoimento['id'] ?>" class="group mx-2 mt-5 mb-20 relative flex items-center justify-center overflow-hidden rounded-xl bg-blue-600 px-6 py-3 text-lg xl:text-xl font-bold text-slate-900 shadow-lg shadow-blue-600/20 border-2 border-blue-500 transition-all duration-300 hover:-translate-y-1  hover:bg-blue-500 hover:shadow-xl hover:shadow-blue-600/40 active:translate-y-0">
                            <span class="relative z-10 transition-transform duration-300 group-hover:scale-105">
                                Aprovar
                            </span>
                        </button>
                ...
                <div class="m-10 h-fit bg-slate-700 flex-col rounded-2xl flex w-1/2 justify-around p-10 font-semibold text-2xl text-amber-100 drop-shadow-[15px_15px_7px_rgba(0,0,30,.7)]">
                    <h1 class="text-center text-3xl font-bold mb-6 text-amber-600">Comentários aprovados para aparecer:</h1>
                    ...
                    <form action="./src/uploads/offcomment.php" method="post">
                        <button type="submit" name="aprovar" value="<?= $depoimento['id'] ?>" class="group mx-2 mt-5 mb-20 relative flex items-center justify-center overflow-hidden rounded-xl bg-red-600 px-6 py-3 text-lg xl:text-xl font-bold text-slate-900 shadow-lg shadow-blue-600/20 border-2 border-red-500 transition-all duration-300 hover:-translate-y-1  hover:bg-red-500 hover:shadow-xl hover:shadow-blue-600/40 active:translate-y-0">
                            <span class="relative z-10 transition-transform duration-300 group-hover:scale-105">
                                Reprovar
                            </span>
                        </button>
                ...
                <p class="text-red-500 text-center font-extrabold">Nenhum comentário aprovado</p>  
